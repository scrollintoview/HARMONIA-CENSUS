...
********************************************************************************/
function unitTest_AUT_TC102_Validate_items_on_header_top_links(){
...
linksobj =  {
  ...
  AUT_TC102_Validate_items_on_header_top_links(linksobj);

}
function AUT_TC102_Validate_items_on_header_top_links(links){
  try {
           var obj;
           for(var  i in links){
