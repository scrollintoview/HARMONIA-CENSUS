...
function unitTest_AUT_TC103_Validate_topics_drop_down_menus_on_header (){
    var menuitems = {
      item1 :"TOPICS",
      item2 :"GEOGRAPHY",
      item3 :"LIBRARY",
     ...
     AUT_TC102_Validate_items_on_header_top_links(menuitems);
}

function AUT_TC102_Validate_items_on_header_top_links(menuitems){
 try{
